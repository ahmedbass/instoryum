...
const SearchResults = (props ) => {
  const searchResults = [
    { image: "", username: "It's AAAAzzyyyyy", fullName: "Aazzy Pizza", isFollowing: true },
    {
      image: "",
      username: "Ahmed__3D",
      fullName: "Ahmed Bass",
  ...
  return (
    <div
      className="bg-white rounded-lg shadow-lg z-10 w-screen md:w-[30rem] h-96
    ...
    >
      <div className="p-4 pb-2 flex justify-between">
        ...
        <p className="font-semibold text-blue-400 text-lg cursor-pointer">
          Clear all
        </p>
      </div>
