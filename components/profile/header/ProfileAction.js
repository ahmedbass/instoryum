...
const MyselfActions = () => (
    <>
      <MyButton hollow>Edit profile</MyButton>
...
const AmFollowingActions = () => (
    <div className="flex space-x-2">
      <MyButton hollow responsive>Message</MyButton>
      <MyButton hollow>
        <MyIcon Icon={FaUserCheck} size={2} hover={false} className="px-4" onClick={() => console.log("unfriend?")}/>
      </MyButton>
    </div>
);
...
const MoreActions = () => (
    <MyIcon Icon={FiMoreHorizontal} onClick={() => console.log("more...")}/>
);
