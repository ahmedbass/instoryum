...
const ImageEditor = ({ clearSelection, removeFromSelection, addToSelection }) => {
  ...
  return (
    <section className={`relative w-full md:w-[60vw] md:max-w-[50rem] h-1/2 md:h-full flex-grow `}>
      <HeroImage />
      ...
      {showAspectRatio && <AspectRatioControl />}
